...
comm_vbfnlo_herwig="rivet-mkhtml -n5 -o ~/www/Rivet/rivet-plots-VBFNLO-Herwig_FIX  -c style_WZVBS_LesHouchesStudy.plot  -m ".*/WZVBS_LesHouchesStudy/Wm.*OF.*" ../data/minus_CUETP8M1.yoda:$VBFNLOPY ../data/WmZTo1E1Nu2Mu_FixedScaleMW_LHConfig_ShowerFix_VBFNLO-Herwig7.yoda:$VBFNLOHW ../data/WmZTo1E1Nu2Mu_FixedScaleMW_LHConfig_ShowerFix_VBFNLO-Herwig7_viaMichael.yoda:$VBFNLOHW_FIX ../data/WmZTo1E1Nu2Mu_FixedScaleMW_LHConfig_ShowerFix_VBFNLO-Herwig7_viaMatthias.yoda:$VBFNLOHW_FIX_MAT"
