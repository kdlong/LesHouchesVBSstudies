...
VBFNLOHW_SO="'Scale=45199889:Title={VBFNLO+Herwig7 via LHE}:LineColor=yellow:ErrorBandColor=yellow:ErrorBands=1:ErrorBandOpacity=0.3:LineWidth=0.02'"
...
comm_vbfnlo_herwig="rivet-mkhtml -n5 -o rivet-plots-MG-VBFNLO-FIXEDMW  -c style_WZVBS_LesHouchesStudy.plot  -m ".*/WZVBS_LesHouchesStudy/Wm.*OF.*" ../data/WZTo1E1Nu2Mu_FixedScaleMW_LHConfig_VBFNLO-Pythia8.yoda:$VBFNLOPY ../data/WmZTo1E1Nu2Mu_FixedScaleMW_LHConfig_VBFNLO-Herwig7.yoda:$VBFNLOHW_SO ../data/WmZTo1E1Nu2Mu_FixedScaleMW_LHConfig_fromLHE_VBFNLO-Herwig7.yoda:$VBFNLOHW"
