...
VBFNLOPY="'Title={VBFNLO+PYTHIA}:ErrorBands=1:ErrorBandOpacity=0.1:LineWidth=0.02'"
...
comm="rivet-mkhtml -n5 -c style_WZVBS_LesHouchesStudy.plot  -m ".*/WZVBS_LesHouchesStudy/.*" data/WLLJJ_EWK-MGLO_CentralSample.yoda:$MGCENTRAL data/WZTo1E2Mu_FixedScaleMW_LHConfig_madgraph-pythia8.yoda:$MGEMMFIXED data/VBFNLO_PYTHIA8_80M.yoda:$VBFNLOPY data/WmZTo1E1Nu2Mu_FixedScaleMW_LHConfig_VBFNLO-Herwig7.yoda:$VBFNLOHW"
