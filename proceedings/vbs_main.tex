...
\protect\footnote{Section coordinators: K.~D.~Long, M.~Pellen}$^{,}$ 
...
The electroweak (EW) production of vector-boson pairs in association with two jets at the Large Hadron Collider (LHC) in CERN represents a very important type of processes both theoretically and experimentally.
...
It prevents the cross section from diverging in the high-energy limit and preserve the unitarity of the associated scattering amplitudes.
...
These are particularly challenging measurements due to the high multiplicity of the processes and their small cross sections.
The best measurement \cite{Aad:2014zda,Khachatryan:2014sta,Sirunyan:2017ret,Aaboud:2016ffv} concerns the signature where the scattering of two same sign W boson occurs (usually denoted ${\rm W}^\pm{\rm W}^\pm{\rm j}{\rm j}$).
The reason for this is that it possesses a very specific structure due to the same-sign charged leptons in the final state.
Therefore, in addition to having a rather large cross section, it also features a low irreducible background.
Other signatures such as ${\rm Z}{\rm Z}{\rm j}{\rm j}$, ${\rm W}^+{\rm W}^-{\rm j}{\rm j}$, or ${\rm W}^{\pm}{\rm Z}{\rm j}{\rm j}$ are even more challenging due to the lower cross section and larger irreducible background.
Nonetheless, observations have already been performed at the LHC for both the ${\rm Z}{\rm Z}{\rm j}{\rm j}$ \cite{Sirunyan:2017fvv} and ${\rm W}^{\pm}{\rm Z}{\rm j}{\rm j}$ \cite{Aad:2016ett} scattering.

Therefore, ${\rm W}^{\pm}{\rm Z}{\rm j}{\rm j}$ is likely to be one of the signatures to be measured next.
Hence, a preliminary study on this process is highly desirable.
It will probably help the experimental collaborations to investigate more efficiently the EW production of ${\rm W}^{\pm}{\rm Z}$ in association with two jets.
...
Experimentally, the measurement of the EW contribution to the ${\rm W}^{\pm}{\rm Z}{\rm j}{\rm j}$ is very challenging.
The reasons for this is that is possesses a rather low cross section while having a large irreducible background.
Indeed, due to its colour structure, the ${\rm W}^{\pm}{\rm Z}{\rm j}{\rm j}$ signature possesses three different contributions at LO.
The first one is the one of order $\mathcal{O} (\alpha^6)$ which is usually referred to as the EW component or even VBS component (even if it also possesses non-VBS contributions such as tri-boson ones).
...
Also, Monte Carlo generators comparisons are sometimes done with different input parameters.
These different input parameters (such as \emph{e.g.}\ parton density function (PDF)) can have a significant impact on the predictions both in shape and normalisation.
In the present study we use a common set-up for all predictions at LO accuracy possibly supplemented with a parton shower with realistic experimental event selection.
...
The programs used in the present work are also briefly described there.
...
at the level of color-ordered sub-amplitudes.
...
\Herwig~7.1 release. The PDF sets that have been used the parton shower are MMHT2014lo68cl and
...
In the upper plot the absolute predictions for each component as well as they sum are displayed.
In the lower plot, each contribution is normalised to the sum and expressed in per cent.
...
The cuts are clearly visible on the plots and it is easily understandable why there are enhancing the EW contribution.
Toward high invariant-mass, the EW component becomes more and more important.
It even become of the same size as the QCD one for an invariant-mass of $2000{\sc GeV}$.
...
The measurement of the EW component of the ${\rm p}{\rm p} \to {\rm W}^{\pm}{\rm Z}{\rm j}{\rm j}$ process constitute a real challenge for experimental collaborations.
...
After parton shower, the agreement is in general worth \MP{To be specified as a function of the final results/comments}.
