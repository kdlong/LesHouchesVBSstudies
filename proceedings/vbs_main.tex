...
for the jet rapidity separation, all predictions agree within statistical uncertainties over the whole range. For the di-jet mass, statistically significant differences are more pronounced towards higher masses between {\sc MG5\_aMC} and other generators. This difference was not fully understood, but could be attributed to undestimation of statistical uncertainties or subtle configuration differences.
...
We stress that such differences of configuration should be considered inpependently of typical estimates of theoretical uncertainties such as QCD scale and PDF uncertainties. 
