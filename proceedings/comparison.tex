...
In general, too aggressive estimations of the statistical errors as well as misconfiguration of the run cannot be excluded.
...
These differences are more pronounced in Fig.~\ref{vbs_fig_shower_1b} where
the Zeppenfeld variable for the three charged leptons and the third jet as well as the number of jets is displayed.
...
For the invariant mass of the two jets as well as the transverse momentum of the anti-muon--muon system, we see that for both generators, the use of fixed scale enhances the predictions toward high transverse momentum.
